...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | BoxUI-kjeden | `BoxUiLayout::prepare` | `src/renderer/boxui/BoxUiLayout.cpp` | modell, snapshot og child SVG → statisk/interaktiv frame | avviser ugyldige/gamle data | Planned |
