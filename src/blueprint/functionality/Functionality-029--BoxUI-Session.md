...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | BoxUI-kjeden | `BoxUiSession::dispatch` | `src/application/boxui/BoxUiSession.cpp` | validert intent → lokal syntetisk deltaker og command-ledger | avviser ugyldige/gamle data | Implemented |
