...
set_tests_properties(BoxUiGuiTest PROPERTIES TIMEOUT 60 LABELS GUI)
if(XFMD_SANITIZERS)
  set_tests_properties(BoxUiGuiTest PROPERTIES ENVIRONMENT "LSAN_OPTIONS=suppressions=${CMAKE_CURRENT_SOURCE_DIR}/tests/support/lsan.supp;ASAN_OPTIONS=detect_leaks=1:halt_on_error=1;UBSAN_OPTIONS=halt_on_error=1:print_stacktrace=1")
endif()
add_test(NAME BoxUiPdfTest COMMAND ${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/tools/check_boxui_pdf.py ${CMAKE_BINARY_DIR}/boxui-native.pdf)
set_tests_properties(BoxUiPdfTest PROPERTIES DEPENDS BoxUiGuiTest)
