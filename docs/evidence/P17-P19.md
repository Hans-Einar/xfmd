...
7. Tooltip-tekst og native pilknapper fikk eksplisitt palettoppdatering ved levende
   temabytte. UiControlsTest kontrollerer kontrastfargene sammen med input/fokus.
...
Etter kontrastrettingen bestod UiControlsTest og AppearancePreferencesTest i
Release (2/2), samt UiControlsTest med sanitizer (1/1). Ingen lang batteri-/soak-test.
