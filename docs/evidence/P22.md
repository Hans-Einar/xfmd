...
Installert binær og build-release/xfmd har samme SHA-256: `8f9dce96702418c481038c372aa03dbec783a8465ec8aba92a43a7c06540e12b`.
...
## Avsluttende hover-review

Etter de komplette lokale kjøringene ble FOXs mnemonic-tolkning av `&` funnet
ved kildegjennomgang. Hover og gjenopprettet statustekst escapes nå for FXLabel,
slik at URL-query og filnavn vises ordrett. CompactWorkspaceTest inkluderer begge
måltyper med `&`, og gjenoppretting av status med `&`.
Release: `ctest --test-dir build-release --output-on-failure -R '^CompactWorkspaceTest$'`
består 1/1 (4,77 s). [Sanitizer-regresjonen](P22/hover-literal-sanitizers.txt)
består 1/1 mot samme retting. Fase-PR kjører hele matrisen mot siste commit.
Installert binær/hash over er oppdatert etter rettingen.
