...
Status: **fullført**, 2026-09-13. Miljø: Fedora Linux, x86_64, Intel Core i5-7200U
...
Sluttmåling mot M1-koden, gjentatt etter siste fontmetrikksikring. Målt varm p95: parse 37.46 ms, layout 56.72 ms, samlet 87.67 ms.
Benchmark peak RSS 49 660 KiB. Egen prosess fra oppstart til første tilgjengelige
frame og behandlet paint-event: 224.85 ms, peak RSS 83 632 KiB.
...
Siste [CI-kjøring mot 1a686bd](https://github.com/Hans-Einar/xfmd/actions/runs/34721949457)
bestod begge Ubuntu 24.04-jobbene: 15 tester uten sanitizers, 14 med ASan/UBSan,
samt bootstrap, bygg og installasjon. Sluttcommitten endrer bare dokumentert
status/målinger; produksjonskode og testoppsett er identisk med denne kjøringen.
