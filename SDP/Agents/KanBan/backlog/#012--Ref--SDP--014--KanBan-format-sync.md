...
## Original need and owner direction — 2026-09-24
...
## Pre-migration evidence and upstream direction — 2026-09-24
...
- Apply the owner's 2026-09-25 decision: use SDP/Agents/KanBan and the pinned
  [upstream baseline](../Upstream.md). Keep existing implementation records
  authoritative during adoption. Do not copy real SDP cards into the XFMD board.
...
EVT-KB-XFMD-000053: relocated the board and added visible CardState (backlog).
...
## Current outcome and remaining scope

SDP1-M1 delivers the local baseline alignment: CardState, worklogs, typed payload
0.2 lineage, local schemas and validation. Earlier gap descriptions above record
